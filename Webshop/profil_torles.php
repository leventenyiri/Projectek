...
<div class="container">
        <div class="centered-content2">
            <form class="my-5 centered-form" action="profil_delete.php" method="post">
                <h1 class="mb-4">Profil törlése</h1>
                ...
                <button type="submit" class="btn btn-primary custom-button" name="uj">Törlés</button>
            </form>
        </div>
</div>
